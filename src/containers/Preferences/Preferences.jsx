        ...
        <div className="full-width svg-banner">
            <div>
                <svg xmlns="http://www.w3.org/2000/svg" width="19.586" height="18.869" viewBox="0 0 19.586 18.869">
                    <path id="Back" d="M20,11.25a2.812,2.812,0,0,0-2.5-2.5H4.813l5.219-5.219A2.79,2.79,0,0,0,10,0h0L.707,9.293a1,1,0,0,0,0,1.414L8.25,18.25a2.784,2.784,0,0,0,3.5,0h0l-6.937-7H17.5A2.812,2.812,0,0,0,20,8.75Z" transform="translate(-0.414)" fill="#fff" opacity="0.3"/>
                </svg>
            </div>
  ...
  <div>
      ...
      <div className={'wrapper'}>
          <svg xmlns="http://www.w3.org/2000/svg" width="329" height="78" viewBox="0 0 329 78">
              <text id="Social_Me" data-name="Social Me" fill="#1b3543" font-size="24" font-family="Montserrat-SemiBold, Montserrat" font-weight="600"><tspan x="0" y="23">What type of feedback </tspan><tspan x="0" y="59">would you like to give?</tspan></text>
          </svg>
          ...
          <div style={{
              ...
              <HITCard styles={{marginLeft: 0}} />
              <PROCard styles={{marginRight: 0}} />
          </div>
...
Preferences.propTypes = {
  // bla: PropTypes.string,
    feedbackType: PropTypes.oneOf(['HIT', "PRO"]),
};
