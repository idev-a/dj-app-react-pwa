export default {
    UPGRADE_TO_PRO: "UPGRADE TO HEARBK PRO",
    BECOME_AN_INSIDER: "BECOME AN INSIDER",
    CURRENCY_SIGN: "$",
    PRO_AMOUNT: "99.00",
    PER_YEAR: "/ year",
    BILLING_DETAILS: "Billed annually, auto-renew, cancel anytime.",
    PRO_DESCRIPTION_1: "We are developing a suite of tools to help you find listeners who are more likely to want to hear your tracks.",
