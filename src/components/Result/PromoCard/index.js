...
const PromoCard = ({ hasKey, hasFeedback }) => {
        ...
        <div className={hasKey ? "promo-campaign-card-border" : "promo-campaign-card"}>
            <div className="promo-camaign-inner-container">
                <div className="like-container">
                    ...
                    <span className="like-percentage-txt">90%</span>
                </div>
                <div className="promo-campaign-inner-container">
                    <div className="card-container-2">
                        <small className="subscription-date-text">05/01/2020 - 05/06/2020</small>
                        {!cardIsOpen &&
            ...
            {cardIsOpen &&
                <div className="card-inner-container">
                    <div className="title-track-container">
                        <small>Title track</small>
                        <small>4:11</small>
                    </div>
                    <div className="card-icons-container">
                        <div className="icon-first-row">
                            <IconContainer icon={<Social className="icon-3" />} number="299" text="Listners" />
                            <IconContainer icon={<Like className="icon-3" />} number="90%" text="Thumbs Up" />
                            <IconContainer icon={<ThumbsDown className="icon-3" />} number="2%" text="Thumbs Down" />
                        </div>
