...
const EmailSignIn = ({ emailSigninBack, emailSigninClose, emailSignupPage, emailresetPassword, onInputChange, email, password, loginUser, loginDetails }) => {
    const [values, setValues] = React.useState({
        showPassword: false,
    });
    const [showAlertContainer, setAlertContainer] = useState(false)
    ...
    const toggleAlertContainer = useCallback(() => {
        setAlertContainer(!showAlertContainer);
    }, [showAlertContainer])
        ...
        <div className="emailSigninContainer">
            ...
            <div className="signinEmailBox">
                ...
                <div className="signinform-container">
                    ...
                    <button className="signinButton" onClick={handleOnSignin} >{content.LOGIN_LABEL}</button>
            ...
            {showAlertContainer &&
                <DialogBox
                    bodyComponent={
                        <AlertContainer
                            alertTitle={"Please enter valid credentials"}
                            handleOnClickButton={toggleAlertContainer}
                            buttonText={"Okay"}
                        />
                    }
                    onClose={toggleAlertContainer}
                />
            }
        </div>
    )
